        ...
        <Flex flexWrap="wrap" alignItems="start" justifyContent="space-between">
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            ...
            <List lineHeight="2" justifyContent="center">
              <LinkItem text="About FoodBuzz" />
              <LinkItem text="About food" />
              <LinkItem text="Blogs" />
            </List>
          </Box>
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            ...
            <List lineHeight="2">
              <LinkItem text="Open restauran on FoodBuzz" />
              <LinkItem text="Become a driver FoodBuzz" isTag={true} tagText="New" />
            </List>
          </Box>
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            <Heading as="h5" color="gray.700" mb="0.5rem" fontSize="0.875rem" fontWeight="600">
            ...
            <List lineHeight="2">
              <LinkItem text="Trung tâm hỗ trợ" />
              <LinkItem text="Câu hỏi thường gặp" />
          ...
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            ...
            <List lineHeight="2">
              <LinkItem text="hoailam03999@gmai.com" />
              <LinkItem text="0362685068" />
              <LinkItem text="9 Pham Phu Thu, phuong 11, Tan Binh Dustric" />
            </List>
          </Box>
        </Flex>
      </Box>
